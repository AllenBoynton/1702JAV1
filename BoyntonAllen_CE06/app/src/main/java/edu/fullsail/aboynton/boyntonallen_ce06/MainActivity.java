...
public class MainActivity extends AppCompatActivity {
    ...
    // 2 screens (LinearLayouts) to determine whether Visible or Gone
    private View personsListScreen;
    private View personsGridScreen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        personsListScreen = findViewById(R.id.person_list_screen);
        personsGridScreen = findViewById(R.id.person_grid_screen);

        // Views resource position
        listView = (ListView)personsListScreen.findViewById(R.id.listView);
        gridView = (GridView)personsGridScreen.findViewById(gridview);
        ...
        showPersonsListScreen(personList);
        showPersonsGridScreen(personList);
    }
    ...
    public void showPersonsListScreen(ArrayList<Person> personList) {
        personsGridScreen.setVisibility(View.GONE);
        personsListScreen.setVisibility(View.VISIBLE);

        listView.setAdapter(new PersonsAdapter(this, personList));
    }

    public void showPersonsGridScreen(ArrayList<Person> personList) {
        personsListScreen.setVisibility(View.GONE);
        personsGridScreen.setVisibility(View.VISIBLE);
